...
public class ChannelManager implements LunaChatAPI {
     ...
     * @return 存在するかどうか
     * @see com.github.ucchyocean.lc.LunaChatAPI#isExistChannel(String)
     */
    @Override
     ...
     * @param playerName プレイヤー名
     * @return チャンネル
     * @see com.github.ucchyocean.lc.LunaChatAPI#getChannelsByPlayer(String)
     */
    @Override
     ...
     * @return チャンネル
     * @see com.github.ucchyocean.lc.LunaChatAPI#getDefaultChannel(String)
     */
    @Override
     ...
     * @param playerName プレイヤー
     * @param channelName チャンネル名
     * @see com.github.ucchyocean.lc.LunaChatAPI#setDefaultChannel(String, String)
     */
    @Override
     ...
     * @param playerName プレイヤー名
     * @see com.github.ucchyocean.lc.LunaChatAPI#removeDefaultChannel(String)
     */
    @Override
     ...
     * @return チャンネル
     * @see com.github.ucchyocean.lc.LunaChatAPI#getChannel(String)
     */
    @Override
     ...
     * @param channelName チャンネル名
     * @return 作成されたチャンネル
     * @see com.github.ucchyocean.lc.LunaChatAPI#createChannel(String)
     */
    @Override
     ...
     * @return 作成されたチャンネル
     * @see com.github.ucchyocean.lc.LunaChatAPI#createChannel(String, com.github.ucchyocean.lc.member.ChannelMember)
     */
    @Override
     ...
     * @return 削除したかどうか
     * @see com.github.ucchyocean.lc.LunaChatAPI#removeChannel(String)
     */
    @Override
     ...
     * @return 削除したかどうか
     * @see com.github.ucchyocean.lc.LunaChatAPI#removeChannel(String, com.github.ucchyocean.lc.member.ChannelMember)
     */
    @Override
     ...
     * @param id テンプレートID
     * @return テンプレート
     * @see com.github.ucchyocean.lc.LunaChatAPI#getTemplate(String)
     */
    @Override
     ...
     * @see com.github.ucchyocean.lc.LunaChatAPI#setTemplate(String, String)
     */
    @Override
     ...
     * テンプレートを削除する
     * @param id テンプレートID
     * @see com.github.ucchyocean.lc.LunaChatAPI#removeTemplate(String)
     */
    @Override
