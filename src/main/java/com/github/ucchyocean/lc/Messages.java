...
public class Messages {
    ...
    public static Component joinMessage(Object color, Object channel, Object player) {
        ...
        if ( msg == null ) return Component.text().build();
     ...
     */
    public static Optional<Component> banNGWordMessage(Object color, Object channel, Object player) {
        ...
        cf.replace("%channel%", channel.toString());
        cf.replace("%player%", player.toString());
        return Optional.of(cf.makeTextComponent());
    }

    /**
     * &f[%color%%channel%&f]&7NGワード発言により、%player% さんをチャンネルから自動キックしました。
     */
    public static Optional<Component> kickNGWordMessage(Object color, Object channel, Object player) {
     ...
     */
    public static Optional<Component> muteNGWordMessage(Object color, Object channel, Object player) {
     ...
     */
    public static Optional<Component> expiredBanMessage(Object color, Object channel, Object player) {
     ...
     */
    public static Optional<Component> expiredMuteMessage(Object color, Object channel, Object player) {
